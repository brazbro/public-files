...
# Create inductor cache dir
INDUCTOR_CACHE_DIR="${DATA_DIRECTORY}/inductor_cache"
mkdir -p "${INDUCTOR_CACHE_DIR}"
chown root:root "${INDUCTOR_CACHE_DIR}"
...
[program:dia]
environment=PROC_NAME="%(program_name)s",TORCHINDUCTOR_CACHE_DIR="${INDUCTOR_CACHE_DIR}"
